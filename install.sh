...
echo ""
echo -e "${COLOR_YELLOW}Important:${COLOR_RESET} Synapse works best with ${COLOR_GREEN}--dangerously-skip-permissions${COLOR_RESET}."
echo "  Multi-agent workflows require uninterrupted tool execution."
echo "  Start sessions with:  claude --dangerously-skip-permissions"
echo ""
echo "  Add an alias to your shell config (~/.bashrc or ~/.zshrc):"
echo "    alias cs='claude --dangerously-skip-permissions'"
echo ""
echo -e "${COLOR_BOLD}Next step:${COLOR_RESET} Run ${COLOR_GREEN}/synapse:init${COLOR_RESET} in Claude Code to initialize this project."
echo ""
